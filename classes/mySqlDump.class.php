...
class mySqlDump {
    ...
    public $pass;
    public $db;
    public $fileName = 'submissions/db_construct.sql';
     ...
     * @return null
     */
    public function __construct($type="mysql", $settings = null, $pdo_options = array(PDO::ATTR_PERSISTENT => true, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION))
    {
        $this->db = _DB_NAME_;
        $this->user = _DB_USER_;
        $this->pass = _DB_PASSWD_;
    ...
    public function start($filename = '')
    {
        ...
        echo "Please email the following URL to Perspektive Designs: <strong>" . $filename = $_SERVER["REQUEST_URI"] . " WITH b_construct.sql</strong>";
    }
